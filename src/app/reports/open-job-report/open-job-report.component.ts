...
@Component({
  selector: 'app-open-job-report',
  templateUrl: './open-job-report.component.html',
  styleUrls: ['./open-job-report.component.css']
})
export class OpenJobReportComponent implements OnInit {
  ...
  JobOpenCloseDD: any[] = [{'Id' : '0', 'TEXT' : 'Open'}, {'Id' : '1', 'TEXT' : 'Close'}]
    ...
    if ((this.StartDate != null || this.StartDate != undefined)) {
      {
        ...
        requestData.push({
          "Key": "APIType",
          "Value": "GetJobAsOnDateReportList"
        })
        requestData.push({
          "Key": "LocationXml",
          "Value": this.LocationData == null || this.LocationData == undefined ? '' : this.GetLocationCodeXML()
        })
        ...
        requestData.push({
          "Key": "HandoverFlag",
          "Value": this.HandoverFlag == null || this.HandoverFlag == undefined ?null : this.HandoverFlag
        })
      ...
      this.toast.error("Please Select As on Date")
    }
  ...
  exportReportData() {
    ...
    if ((this.StartDate != null || this.StartDate != undefined) ) {
      ...
      requestData.push({
        "Key": "APIType",
        "Value": "ExportJobAsOnDateReportList"
      })
      requestData.push({
        "Key": "LocationXml",
        "Value": this.LocationData == null || this.LocationData == undefined ? '' : this.GetLocationCodeXML()
          ...
          next: (Value) => {
            try {
              const startformattedDate = this.datePipe.transform(this.StartDate, 'dd-MM-yyyy');
                ...
                link.href = url;
                const fileName = `As_On_Date_Job_Report_${startformattedDate}.xls`;
