...
@Component({
  selector: 'app-discount-kitty-approval',
  templateUrl: './discount-kitty-approval.component.html',
  styleUrls: ['./discount-kitty-approval.component.css']
})
export class DiscountKittyApprovalComponent implements OnInit {
  ...
  columns: Columns[] = [
    ...
    { datatype: "NUMBER", field: "RequestAmount", title: "Request Amount" },
    { datatype: "STRING", field: "RequestStatus", title: "Request Status" },
    { datatype: "STRING", field: "RequestRemark", title: "Request Remark" },
  ...
  add() {
    this.route.navigate(['/auth/' + glob.getCompanyCode() + '/discount-kitty-approval']);
  }
  ...
  GetDiscountKitty(eventDetail) {
    ...
    requestData.push({
      "Key": "APIType",
      "Value": "GetDiscountKittyApprovalList"
    });
          ...
          try {
            ...
            if (response.ReturnCode == '0') {
              ...
              if (data?.Totalrecords < 1) {
                ...
                Array.isArray(data.DiscountKittyApprovalList.DiscountKittyApproval)
                  ? this.results = data.DiscountKittyApprovalList.DiscountKittyApproval
                  : this.results = [data.DiscountKittyApprovalList.DiscountKittyApproval]
  ...
  actionEmit(event): void { 
    ...
    if (event.action === 'EDIT') {
      ...
      this.route.navigate(
        ['/auth', companyCode, 'discount-kitty-approval'],
        { queryParams: { guid: event.row.ApprovalGUID } }
      );
    }
  }
