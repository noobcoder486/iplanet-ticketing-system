...
@Component({
  selector: 'app-nret-management-list',
  templateUrl: './nret-management-list.component.html',
  styleUrls: ['./nret-management-list.component.css']
})
export class NretManagementListComponent implements OnInit {
  ...
  pageTitle: String = "NRET Management";
  ...
  actionEmit(event){
    ...
    if(event.action == 'EDIT'){
      this.route.navigate(['/auth/'+glob.getCompanyCode()+'/nret-management'], { queryParams: { headerguid: event.row.DeliveryChallanGUID} })
    }
  }
  ...
  add(){
    this.route.navigate(['/auth/'+glob.getCompanyCode()+'/nret-management/']);
  }
