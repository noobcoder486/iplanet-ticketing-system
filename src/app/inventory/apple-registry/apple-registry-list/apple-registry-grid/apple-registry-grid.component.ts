...
@Component({
  selector: 'app-apple-registry-grid',
  templateUrl: './apple-registry-grid.component.html',
  styleUrls: ['./apple-registry-grid.component.css']
})
export class AppleRegistryGridComponent implements OnInit {
