import { Component, Input,SimpleChanges,Output, OnInit,EventEmitter,Inject, Optional } from '@angular/core';
...
export class FeedbackComponent implements OnInit {
  ...
  constructor(private dropdownDataService: DropdownDataService,
    ...
    @Optional() public dialogRef: MatDialogRef<FeedbackComponent>,
  ...
  ngOnInit(): void {
    ...
    if(!(this.data == undefined  || this.data == null))
    {
        ...
        console.log("Ques D  ", this.questions)
    }
    else
    {
...
ngOnChanges(changes: SimpleChanges): void{
  ...
  onSave(){
    ...
    if(this.questions != null){
      for(let template of this.questions){
        ...
        var template1=null;
        console.log("Ques Ans  ", this.questions)
    ...
    if(this.data == undefined || this.data==null)
    {
      this.RepairQuestions.emit(this.questionDetails)
    }
    else
    {
  ...
  getQuestionAnswer(questions)
  {
      ...
      for (let question of questions)
      {
        ...
        // else if( question.answerType == 'INT' || question.answerType == 'FFB' || question.answerType == 'BBX' ) {
        //     
        //     if( typeof question.selectAnswer  === 'string' ){
        //       if(question.selectAnswer.toString().trim() != ''){
        //           if(questionDetails==null)
        ...
        //           quest.answers.push({
        //             // "answerId":question.selectAnswer.answerId,
        //             "answerPhrase":question.selectAnswer
        //           })
        //           if(!(quest == null || quest == undefined))
        //           {
        //             questionDetails.push(quest)
  ...
  //     for (let question of questions)
  //     {
  //       if(question.selectAnswer != undefined && question.selectAnswer != null &&  question.selectAnswer != ''  && question.answerType != 'INT'  && question.answerType != 'BBX' ) {
  ...
  //               }
  //               
  //               if(question.answerType=='FFB')
  //               {
  //               quest.answers.push({
  //                 "answerId":question.selectAnswer.answerId,
  //                 "selected":question.selectAnswer.answerPhrase
  //               })  
  //               }
  //             else{
  //               quest.answers.push({
  ...
  //       }  
  //       console.log("Answer Data ", questionDetails)
  //       return questionDetails ;
  // }
  

  isToEnableSaveButton(){
    //console.log("isToEnableSaveButton", this.questions)
    if(this.questions != null){
      for(let template of this.questions){
        for(let tree of template.trees){
          let value = !this.isQuestionIsAnswered(tree.questions);
          //console.log("isToEnableSaveButton", "if",value)
          return value;
        }
      }
    }
    //console.log("isToEnableSaveButton", "else",true)
    return true;
